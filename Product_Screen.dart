...
import 'package:urbanmed_proj/Cart_Page.dart';
          ...
          return ScopedModelDescendant<CartModel>(
              builder: (context, child, model) {
                return Card( child: Column( children: <Widget>[
                  ...
                  Text(_products[index].Mfd.toString(), style: TextStyle(fontWeight: FontWeight.bold),),
                  Text(_products[index].Exd.toString(), style: TextStyle(fontWeight: FontWeight.bold),),
